...
| Orevx Engine 半公益站 | 半公益站，邮箱或手机注册送 100 算力，每日随机签到 100-200 算力；常见大模型都有，调用速度快。站内同时卖支付宝/微信订阅，免费额度主要靠签到维持。**模型清单与倍率本次未逐项核实**，调用界面在 [llm-dashboard](https://orevx.ai/llm-dashboard/)。 | [注册](https://orevx.ai/login?mode=register&inviteCode=FAGCRGAT) |
