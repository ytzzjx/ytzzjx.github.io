...
const entryTranslations = {
  ...
  "墨白公益站": {
    ...
    updateNote:
      "New listing: a public service limited to five email providers; a 1-10 daily check-in with a second one after joining the official QQ group (two a day); DeepSeek V4.1 Flash is usable for free.",
    summary:
      "A public service limited to gmail / 163 / qq / foxmail / icloud email registration, with email verification and a captcha. The daily check-in grants 1-10, and joining the official QQ group 444158239 (entry answer zakozako) after registering adds a second one — two check-ins a day. DeepSeek V4.1 Flash is usable for free.",
    details:
