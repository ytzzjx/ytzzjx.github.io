...
const siteConfig = {
  ...
  entries: [
    ...
    },
    {
      publishedAt: "2026-08-28 00:00",
      updatedAt: "2026-09-07",
      updateNote: "受此前批量注册影响，现在需要通过新邀请链接重新注册；注册送 43.8 万以上额度，实际以站内为准。",
      kind: "需重新注册 / 注册送 43.8 万以上 / 论坛做任务赚额度",
      name: "ze（芙芙中转站）",
      summary: "受此前有人批量注册影响，站点现在需要通过新的邀请链接重新注册；注册送 43.8 万以上额度，实际数额以站内显示为准。日常额度主要靠去论坛 bbs.kscsnkli.site 做任务赚，也有签到。模型有 GLM-5.3-Flash、GPT-5.6-sol、DeepSeek V4 Pro、GLM-5.2 与 Kimi-K3。",
      details:
        "站点域名为 ai.kscsnkli.site，此前在本合集里记作 Kscsnkli AI，后按站点自称显示为 ze，现在站内名称是「异常芙芙公益」。据用户反馈，此前有人批量注册，当前需要通过新的邀请链接再次注册；新注册会赠送至少 43.8 万额度，实际数额以站内显示为准。此前注册需要邮箱验证，当前门槛也以注册页为准。日常额度的主要来源不是签到而是论坛任务：去 bbs.kscsnkli.site（站内叫「异常芙芙」）做任务赚额度，签到也有。站点使用 NewAPI，模型状态和模型列表能直接在站内查看，定价页也可用。已知模型：GLM-5.3-Flash、GPT-5.6-sol、DeepSeek V4 Pro（0813）、GLM-5.2、Kimi-K3。",
      registration: "受此前批量注册影响，需要使用下面更新后的邀请链接重新注册；此前注册需要邮箱验证，当前门槛以注册页为准。注册送 43.8 万以上额度，实际数额以站内显示为准。",
      signupBonus: "43.8 万以上额度（实际以站内显示为准）",
      dailyCheckin: "有签到；额度主要靠论坛做任务赚",
      models: "GLM-5.3-Flash / GPT-5.6-sol / DeepSeek V4 Pro（0813）/ GLM-5.2 / Kimi-K3",
      experience: "需要重新注册；模型状态直观，额度主要靠论坛任务",
      caveat: "受此前批量注册影响，现在需要重新注册，旧账号不要按仍可直接使用处理；请勿批量注册。注册赠送的准确额度、邮箱验证要求与其他门槛以站内当前显示为准。想持续拿额度还得去论坛 bbs.kscsnkli.site 做任务，光靠签到不够。站点几次改名换型：Kscsnkli AI → ze → 站内现称「异常芙芙公益」，域名一直是 ai.kscsnkli.site。使用前建议先看定价页确认模型可用性。",
      benefits: ["需重新注册", "注册送 43.8 万以上", "论坛做任务赚额度", "有签到", "GLM-5.3-Flash", "GPT-5.6-sol", "DeepSeek V4 Pro", "GLM-5.2", "Kimi-K3"],
      url: "https://ai.kscsnkli.site/sign-up?aff=Chz0",
...
const entryTranslations = {
  ...
  "ze（芙芙中转站）": {
    kind: "Re-registration needed / 438k+ sign-up credit / earn credit on the forum",
    name: "ze (Fufu Relay)",
    updateNote: "After earlier bulk registrations, use the new referral link to register again; sign-up grants at least 438,000 credits, with the actual amount shown on the site.",
    summary:
      "After earlier bulk registrations, the service now requires re-registration through a new referral link. New accounts receive at least 438,000 credits, with the actual amount shown on the site. Ongoing credit mainly comes from completing tasks on the forum at bbs.kscsnkli.site, and there is a check-in too. Models include GLM-5.3-Flash, GPT-5.6-sol, DeepSeek V4 Pro, GLM-5.2, and Kimi-K3.",
    details:
      "The service runs at ai.kscsnkli.site and was previously listed here as Kscsnkli AI, then as ze, the name the site used; in-site it now goes by \"异常芙芙公益\". According to user feedback, earlier bulk registrations mean users now need to register again through the new referral link. New registrations receive at least 438,000 credits; verify the actual amount on the site. Email verification was previously required, and the current gate should likewise be confirmed on the sign-up page. The main source of ongoing credit is not the check-in but forum tasks: head to bbs.kscsnkli.site (\"异常芙芙\" in-site) and complete tasks to earn credit; a check-in exists as well. The service uses NewAPI, and model status, the model list, and pricing are visible on the site. Known models: GLM-5.3-Flash, GPT-5.6-sol, DeepSeek V4 Pro (0813), GLM-5.2, and Kimi-K3.",
    registration: "Because of earlier bulk registrations, register again through the updated referral link below. Email verification was previously required; verify the current gate on the sign-up page. Sign-up grants at least 438,000 credits, with the actual amount shown on the site.",
    signupBonus: "At least 438,000 credits (verify the actual amount on the site)",
    dailyCheckin: "Check-in available; credit mainly comes from forum tasks",
    models: "GLM-5.3-Flash / GPT-5.6-sol / DeepSeek V4 Pro (0813) / GLM-5.2 / Kimi-K3",
    experience: "Re-registration needed; model status is clear and credit mainly comes from forum tasks",
    caveat: "Earlier bulk registrations mean re-registration is now required; do not assume old accounts still work, and do not bulk-register accounts. Confirm the exact sign-up grant, email-verification requirement, and other current gates on the site. For a steady credit supply, complete tasks on the forum at bbs.kscsnkli.site; the check-in alone will not carry you. The service has been renamed and re-platformed several times: Kscsnkli AI → ze → currently \"异常芙芙公益\" in-site, always at ai.kscsnkli.site. Check the pricing page for model availability before use.",
    benefits: ["Re-registration needed", "438k+ sign-up credit", "Earn credit via forum tasks", "Check-in available", "GLM-5.3-Flash", "GPT-5.6-sol", "DeepSeek V4 Pro", "GLM-5.2", "Kimi-K3"],
