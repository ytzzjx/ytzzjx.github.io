  ...
  entries: [
    {
      ...
      updateNote: "新增收录：邀请注册送 0.2 刀，每日签到 5 刀，有 Claude 和 DeepSeek，酒馆站。",
      kind: "半公益站 / 邀请注册送 0.2 刀 / 酒馆站",
      name: "Ksir的小饭锅",
      summary: "半公益酒馆站，邀请注册送 0.2 刀、每日签到 5 刀；站内有 Claude 和 DeepSeek 可用。",
      details:
        "面向酒馆（SillyTavern）用户的半公益站。走邀请链接注册送 0.2 刀，每日签到得 5 刀，额度主要靠签到维持；站内有 Claude 和 DeepSeek 可用。倍率和模型清单以站内实际显示为准。",
      registration: "通过邀请链接注册。",
      signupBonus: "0.2 刀",
      dailyCheckin: "5 刀",
      models: "Claude / DeepSeek",
      experience: "酒馆站，额度靠每日签到维持",
      caveat: "半公益站，倍率、模型清单和充值规则可能调整，请以站内实际显示为准。",
      benefits: ["半公益站", "酒馆站", "邀请注册送 0.2 刀", "每日签到 5 刀", "Claude", "DeepSeek"],
...
const entryTranslations = {
  "Ksir的小饭锅": {
    ...
    details:
      "A freemium service for SillyTavern users. Registration through the referral link grants $0.2 and the daily check-in adds $5, so credit is mainly sustained by checking in; Claude and DeepSeek are available. Rates and the model lineup should be verified on the service.",
    registration: "Register through the referral link.",
    signupBonus: "$0.2",
    dailyCheckin: "$5",
    models: "Claude / DeepSeek",
    experience: "SillyTavern-oriented; credit is sustained by the daily check-in",
    caveat: "As a freemium service, rates, the model lineup, and top-up rules may change; verify them on the service.",
