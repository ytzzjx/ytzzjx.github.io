...
const siteConfig = {
  ...
  entries: [
    ...
    },
    {
      ...
      updateNote: "更正此前结论：CF 拦的不是 Claude Code 的请求头，开代理就能用，不必改用 Claude Desktop。",
...
const entryTranslations = {
  ...
  KKToken: {
    ...
    updateNote: "Correction: Cloudflare is not targeting the Claude Code request headers. Turning on a proxy is enough, and Claude Desktop is not required.",
    summary:
