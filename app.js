...
const siteConfig = {
  ...
  entries: [
    ...
    },
    {
      ...
      kind: "1M 上下文 / 模型调整",
      name: "AnyRouter",
      summary: "邀请注册送 100，每天签到 25；GPT-5.6-sol 支持 1M 上下文，目前已不再支持 Claude Fabel5。",
      details:
        "GPT-5.6-sol 支持 1M 上下文。站点目前已不再支持 Claude Fabel5；用的人较多，高峰期可能需要反复重试才能挤进去。",
      registration: "Linux Do 二级账号，或 .edu.cn 教育邮箱注册。",
      signupBonus: "100 刀",
      dailyCheckin: "25 刀",
      models: "GPT-5.6-sol（1M 上下文）",
      experience: "GPT-5.6-sol 支持长上下文；高峰期较拥挤",
      caveat: "Claude Fabel5 已不再支持；人多时可能需要反复重试，其他模型范围也请以站内实际列表为准。",
      benefits: ["注册送 100 刀", "每日签到 25 刀", "GPT-5.6-sol", "1M 上下文", "人多需排队"],
...
const entryTranslations = {
  ...
  AnyRouter: {
    kind: "1M context / model change",
    summary:
      "Referral registration grants $100 and daily check-ins add $25. GPT-5.6-sol supports a 1M context window, while Claude Fabel5 is no longer available.",
    details:
      "GPT-5.6-sol supports a 1M context window. Claude Fabel5 is no longer supported. Demand remains high, so several retries may be needed during peak hours.",
    ...
    experience: "Long-context GPT-5.6-sol; busy during peak hours",
    caveat: "Claude Fabel5 is no longer supported. Repeated retries may be needed during peak hours, and other model availability should be verified on the service.",
    benefits: ["$100 sign-up credit", "$25 daily check-in", "GPT-5.6-sol", "1M context", "Busy during peak hours"],
  },
  "Fate New API": {
