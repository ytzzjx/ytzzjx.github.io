...
const siteConfig = {
  ...
  entries: [
    ...
    },
    {
      ...
      kind: "高额稳定 / 1M 上下文",
      name: "AnyRouter",
      summary: "邀请注册送 100，每天签到 25；GPT-5.6-sol 已支持 1M 上下文，也提供 Claude Fabel5。",
      details:
        "GPT-5.6-sol 支持 1M 上下文；Claude Fabel5 只要能连上，速度快、稳定，也没有降智问题。缺点是用的人多，高峰期得多试几次才能挤进去。",
      registration: "Linux Do 二级账号，或 .edu.cn 教育邮箱注册。",
      signupBonus: "100 刀",
      dailyCheckin: "25 刀",
      models: "GPT-5.6-sol（1M 上下文）/ Claude Fabel5",
      experience: "挤进去后速度快、稳定，无降智",
      caveat: "人多，高峰期需要反复重试才能挤进去。",
      benefits: ["注册送 100 刀", "每日签到 25 刀", "GPT-5.6-sol", "1M 上下文", "Claude Fabel5", "无降智", "人多需排队"],
...
const entryTranslations = {
  ...
  AnyRouter: {
    kind: "High bonus / 1M context",
    summary:
      "Referral registration grants $100 and daily check-ins add $25. GPT-5.6-sol now supports a 1M context window, and Claude Fabel5 is also available.",
    details:
      "GPT-5.6-sol supports a 1M context window. Claude Fabel5 is fast, stable, and does not appear degraded once connected. During peak hours you may need to retry several times.",
    registration: "Linux Do level 2 account, or an .edu.cn academic email address.",
    signupBonus: "$100 credit",
    dailyCheckin: "$25",
    models: "GPT-5.6-sol (1M context) / Claude Fabel5",
    ...
    benefits: ["$100 sign-up credit", "$25 daily check-in", "GPT-5.6-sol", "1M context", "Claude Fabel5", "No obvious degradation", "Busy during peak hours"],
  },
  "Fate New API": {
