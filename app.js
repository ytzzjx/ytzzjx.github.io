  ...
  entries: [
    {
      ...
      updateNote:
        "新增收录：8 月底公益开放的 New API 站，模型广场公开可查共 936 个，公益站分组 151 个、公益链分组 24 个（含低价 Claude）；邮箱注册，已开签到。",
      kind: "公益站 / 邮箱注册 / 模型极多",
      name: "墨白公益站",
      summary:
        "公益站，2026 年 8 月底公益开放；模型广场无需登录即可查看，共 936 个模型，其中公益站分组 151 个、公益链分组 24 个（含倍率约 0.137 的 Claude）。限 gmail / 163 / qq / foxmail / icloud 邮箱注册，需邮箱验证和人机验证，已开签到。",
      details:
        "站内名称「墨白 API」，New API 站点，页脚署名 2026 HAGP Team。域名换过：2026 年 8 月 25 日起启用 new.ai.hinswu.top，原 hagp.hinswu.top 已于 9 月 17 日正式下线，注册务必走新域名。额度单位是「猫粮」，按美元显示（汇率约 7）。模型广场公开可查，共 936 个模型，分组包括公益站（151 个，含 kimi-k3、gpt-6-astra、mimo-v2.5-pro、MiniMax-M2.7、Qwen3.8-27B 等）、公益链（24 个，含 claude-sonnet-5、claude-opus-5、claude-fable-5、claude-haiku-4-5、glm-5.3、gemini-3.7-flash、deepseek-v4.1-flash、qwen3.8-flash 等，其中 Claude 倍率约 0.137）、高级模型分组（8 个）等。签到方面：站内可签到，注册后加入官方 QQ 群 444158239 还能再签到一次（进群答案 zakozako，用户提供），相当于每天签到两次，具体金额以站内显示为准。高级模型分组曾因有人拿模型做破甲、逆向、黄文等违规内容，被上游取消合作而下线，9 月 18 日恢复但仅对「正式用户」开放——需在官方 QQ 群内用 /绑定 [网站ID] 完成绑定升级，且公告称部分模型尚未恢复。站方另公告：为保证上游资源，后续会限制部分免费模型需入群解锁；在群里发言不友好会被直接封号并连坐邀请用户。登录方式除邮箱密码外还支持 Passkey 和 OIDC（HINS Auth）。",
      registration: "邮箱注册，限 gmail.com / 163.com / qq.com / foxmail.com / icloud.com，需邮箱验证与人机验证；也支持 Passkey 与 OIDC（HINS Auth）登录。",
      signupBonus: "未提供固定注册赠送；9 月 1 日数据库迁移事故曾补偿猫粮（订阅内领取，有效期 7 天）",
      dailyCheckin: "已开签到；注册后加入官方 QQ 群 444158239 可再签到一次（进群答案 zakozako），相当于每天签到两次，金额未核实",
      models: "模型广场共 936 个；公益站分组 151 个（kimi-k3 / gpt-6-astra / mimo-v2.5-pro / MiniMax-M2.7 / Qwen3.8-27B 等）、公益链分组 24 个（claude-sonnet-5 / claude-opus-5 / claude-fable-5 / glm-5.3 / gemini-3.7-flash / deepseek-v4.1-flash 等）",
      experience: "公益开放，官方明示可用性不保证，免费模型为共享资源，人多时可能 429",
      caveat:
        "站方公告：有人用模型做破甲、逆向、黄文等违规内容导致上游取消合作，高级模型分组被下线后虽恢复但仅对入群绑定的正式用户开放，且部分模型未恢复；后续部分免费模型也需入群解锁，群内发言不友好会封号并连坐邀请用户；Grok 系列 9 月 17 日起因服务器脱网暂不可用；签到金额、免费模型范围与限流规则以站内实际显示为准。",
      benefits: [
        "公益站",
        "邮箱注册",
        "模型极多（936 个）",
    ...
    },
    {
      publishedAt: "2026-08-28 00:00",
      updatedAt: "2026-09-10",
      updateNote: "确认需要重新注册；每天有免费额度，每日额度有限制。",
      ...
      caveat: "受此前批量注册影响，现在需要重新注册，旧账号不要按仍可直接使用处理；请勿批量注册。每天有免费额度，但每日额度已有上限，具体数额、重置规则、注册赠送与邮箱验证要求以站内当前显示为准。想持续拿额度还得去论坛 bbs.kscsnkli.site 做任务，光靠签到不够。站点几次改名换型：Kscsnkli AI → ze → 站内现称「异常芙芙公益」，域名一直是 ai.kscsnkli.site。使用前建议先看定价页确认模型可用性。",
    ...
    },
    {
      ...
      addedAt: "2026-09-10",
      updatedAt: "2026-09-10",
      updateNote: "新收录：仅限 QQ 邮箱注册，加 QQ 群再送 10 余额，可每天签到，倍率极低约等于免费。",
      ...
      caveat:
        "仅允许 QQ 邮箱注册，用其他邮箱大概率注册不了；加群送的 10 余额要进 QQ 群 744474016 才能拿。倍率、分组倍率和每天免费额度的具体数额以站内模型广场和实际显示为准，政策随时可能调整。生图、生视频与嵌入模型质量一般，不要抱太高期待。站内正式名称暂未确认，先按域名记作 Chinahk 公益站。",
      ...
      url: "https://newapi.chinahk.qzz.io/sign-up?aff=rF1K",
      statusUrl: "https://newapi.chinahk.qzz.io/pricing",
...
const entryTranslations = {
  "墨白公益站": {
    ...
    kind: "Public service / email sign-up / very large model lineup",
    updateNote:
      "New listing: a New API service opened for free use at the end of August, with 936 models in the public model marketplace — 151 in the public group and 24 in the public-chain group (including low-rate Claude). Email registration, with a daily check-in and an extra one after joining the QQ group.",
    summary:
      "A public service opened for free use at the end of August 2026. The model marketplace is viewable without logging in and lists 936 models, 151 in the public group and 24 in the public-chain group (including Claude at about a 0.137 rate). Registration is limited to gmail / 163 / qq / foxmail / icloud email addresses, requires email verification and a captcha, and a daily check-in is available — joining the QQ group adds a second one.",
    details:
      "The service calls itself \"Mobai API\" (墨白 API), runs on New API, and is credited to the 2026 HAGP Team. The domain changed: new.ai.hinswu.top has been in use since August 25, 2026, and the original hagp.hinswu.top went offline on September 17, so register through the new domain. Credit is measured in \"cat food\" (猫粮) and displayed in US dollars at an exchange rate of about 7. The public model marketplace lists 936 models across groups including 公益站 (151 models, among them kimi-k3, gpt-6-astra, mimo-v2.5-pro, MiniMax-M2.7, and Qwen3.8-27B), 公益链 (24 models, among them claude-sonnet-5, claude-opus-5, claude-fable-5, claude-haiku-4-5, glm-5.3, gemini-3.7-flash, deepseek-v4.1-flash, and qwen3.8-flash, with Claude billed at about 0.137x), and 高级模型分组 (8 models). Check-ins: one is available on the site itself, and joining the official QQ group 444158239 (entry answer zakozako, per user report) adds a second, so two check-ins a day are possible; confirm the amounts on the service. The premium group was taken offline after users abused models for jailbreaking, reverse engineering, and pornographic content, causing the upstream to end cooperation; it returned on September 18 but only for \"formal users\", who must bind with /绑定 [site ID] inside the official QQ group, and the announcement says some models have not returned. The operator also announced that some free models will later require joining the group to unlock, and that unfriendly speech in the group leads to a platform ban plus a ban on the inviting user. Besides email and password, sign-in also supports Passkey and OIDC (HINS Auth).",
    registration: "Register with an email address limited to gmail.com / 163.com / qq.com / foxmail.com / icloud.com, with email verification and a captcha; Passkey and OIDC (HINS Auth) sign-in are also supported.",
    signupBonus: "No fixed sign-up credit; the September 1 database-migration incident was compensated with cat food (claimed in Subscriptions, valid 7 days)",
    dailyCheckin: "A check-in is available on the site; joining the official QQ group 444158239 (entry answer zakozako) adds a second, so two check-ins a day — amounts unverified",
    models: "936 models in the marketplace; the 公益站 group has 151 (kimi-k3 / gpt-6-astra / mimo-v2.5-pro / MiniMax-M2.7 / Qwen3.8-27B and more) and the 公益链 group has 24 (claude-sonnet-5 / claude-opus-5 / claude-fable-5 / glm-5.3 / gemini-3.7-flash / deepseek-v4.1-flash and more)",
    experience: "Opened for free use, with the operator stating availability is not guaranteed; free models are shared, so 429s are possible under load",
    caveat:
      "Per the operator's announcements, abuse of models for jailbreaking, reverse engineering, and pornographic content caused the upstream to end cooperation; the premium group returned but only for group-bound formal users, with some models still missing. Some free models will later require joining the group to unlock, and unfriendly speech in the group leads to a ban plus a ban on the inviting user. Grok models have been unavailable since September 17 due to a server disconnect. Confirm check-in amounts, the free-model lineup, and rate-limit rules on the service.",
    benefits: [
      "Public service",
      "Email sign-up",
      "Very large lineup (936 models)",
      "151 models in the public group",
      "Low-rate Claude in the public-chain group",
      "kimi-k3",
      "gpt-6-astra",
      "GLM-5.3",
      "DeepSeek V4",
      "Gemini 3.7",
      "Daily check-in, twice with the QQ group",
  ...
  "ze（芙芙中转站）": {
    ...
    name: "ze (Fufu Relay)",
    updateNote: "Re-registration confirmed; free credit is available every day, with a daily cap.",
    summary:
  ...
  "Chinahk 公益站": {
    ...
    name: "Chinahk Public Service",
    updateNote: "New listing: QQ email registration only, an extra 10 in credit for joining the QQ group, daily check-in, and near-free rates.",
    summary:
