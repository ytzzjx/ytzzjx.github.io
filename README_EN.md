...
| Site | Summary | Link |
| --- | --- | --- |
| GcmodAi | Every model is billed **one cent per request** (not token-metered), top-ups are 1:1, and a paid subscription unlocks a VIP group. Sign-up grants 1 yuan, about a hundred requests, **but there is no check-in**, so you top up once it runs out. Kimi-K3, GPT-5.6-luna, and DeepSeek V4 Pro are available. | [Register](https://zc.gcmod.cn/sign-up?aff=4wem) |
