...
| ze (Fufu Relay) | **After earlier bulk registrations, use the new referral link to register again.** New accounts receive **at least 438,000 credits**; verify the actual amount on the site. **Ongoing credit mainly comes from tasks on the forum at [bbs.kscsnkli.site](https://bbs.kscsnkli.site/)**, with a check-in as well. Models include GLM-5.3-Flash, GPT-5.6-sol, DeepSeek V4 Pro, GLM-5.2, and Kimi-K3. Do not bulk-register accounts. | [Register](https://ai.kscsnkli.site/sign-up?aff=Chz0) / [Forum](https://bbs.kscsnkli.site/) |
