...
| Site | Summary | Link |
| --- | --- | --- |
| JustWoker Public Service | **Back online and moved to first place.** It currently supports GPT models only, with Claude no longer available. The previous sign-up gate was a GitHub account at least one year old; verify the current registration and benefit rules on the site. | [Register](https://api.justwoker.icu/sign-up?aff=T5tm) |
